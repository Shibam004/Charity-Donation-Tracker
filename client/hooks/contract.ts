...
export const CONTRACT_ADDRESS =
  "CAJXGQUEE3ZT2UPHWHQC73IW5Q4IHWJK5YCDYZELSUVJ2FEJRW55JIXN";
 ...
 * Calls: donate(donor: Address, amount: i128)
 */
export async function donate(caller: string, amount: bigint) {
  return callContract(
    "donate",
 ...
 * Calls: get_donation(donor: Address) -> i128
 */
export async function getDonation(donor: string, caller?: string) {
  return readContract(
    "get_donation",
...
/**
 * Get total donations across all donors (read-only).
 * Calls: get_total() -> i128
 */
export async function getTotal(caller?: string) {
  return readContract(
    "get_total",
    [],
    caller
